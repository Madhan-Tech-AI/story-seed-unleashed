...
import { Search, Play, SkipBack, SkipForward, Gauge, Captions, CheckCircle2, Send, MessageCircle, Loader2 } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchRegistrations = async () => {
      ...
      const { data, error } = await supabase
        .from('registrations')
        .select('id, story_title, story_description, category, yt_link, user_id, first_name, last_name, created_at')
  ...
  return (
    <div className="space-y-6 page-enter">
      ...
      <Dialog open={isPlayerOpen} onOpenChange={(open) => !open && handleClosePlayer()}>
        <DialogContent className="max-w-5xl md:h-[85vh] p-0 overflow-hidden">
          {selectedStory && (
            <div className="flex flex-col md:flex-row h-full">
              ...
              {/* Info & Voting Panel */}
              <div className="md:w-1/3 flex flex-col bg-card">
